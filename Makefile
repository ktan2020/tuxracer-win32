...
TR_CFLAGS = -g -Wall -I/usr/local/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main
TR_CPPFLAGS =  -I/usr/local/include -DTCL_HEADER=\<tcl.h\> -DHAVE_SDL=1 -DHAVE_SDL_MIXER=1 
TR_CXXFLAGS = -g -Wall -I/usr/local/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main
TR_LIBS =  -luser32 -lgdi32 -ldl -lm -L/usr/local/lib -ltcl84 -L/usr/local/lib -lmingw32 -lSDLmain -lSDL -mwindows -lSDL_mixer  -lopengl32 -lglu32
VERSION = 0.61
...
distdir: $(DISTFILES)
	...
	mkdir $(distdir)
	-chmod 777 $(distdir)
	$(mkinstalldirs) $(distdir)/contrib/script-fu $(distdir)/html \
	   $(distdir)/html/images $(distdir)/html/images/manual
