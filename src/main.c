...
void read_game_init_script()
{
	...
	fprintf(stderr, "Before chdir into: %s \n", getparam_data_dir());
...
int main( int argc, char **argv ) 
{
	...
	*/
	...
	fprintf(stderr, "Creating Tcl interp \n");
    g_game.tcl_interp = Tcl_CreateInterp();
	fprintf(stderr, "After creating Tcl interp \n");
	...
	fprintf(stderr, "before init_game_configuration\n");
    init_game_configuration();
	fprintf(stderr, "after init_game_configuration\n");
	fprintf(stderr, "before read_config_file\n");
    read_config_file();
	fprintf(stderr, "after read_config_file\n");
	...
	fprintf(stderr, "Calling read_game_init_script \n");
